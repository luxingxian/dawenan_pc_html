...
$(document).ready(function () {
                ...
                <ul class="comment_item_user">
                    ...
                    <p class="comment_text_box">
                       ...
                       <span class="comment_time ">${new Date().toLocaleString()}</span>
                        ...
                        <a title="删除 " class="reply" id='delete'>删除</a>
    ...
    $(".comment_item .comment_item_content #delete").click(function () {
        $(this).parents(".comment_item").remove()
    })


    $(".text .show_big_img").click(function () {
        $("body").css("overflow", "hidden");
        $(".big_img_url").attr("src", $(this).find(".text_img").attr("src"));
        $("#mask").show();
        $(".big_img_box").addClass("show")

    })

    $("#closeMask").click(function () {
        $("#mask").hide();
        $(".big_img_box").removeClass("show")
